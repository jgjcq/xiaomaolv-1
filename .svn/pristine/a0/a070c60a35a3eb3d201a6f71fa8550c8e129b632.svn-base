...
{	
	...
	{ 
		try
		{
			...
			/*elseif ($this->parameters["trade_type"] == "JSAPI" &&
		   	...
		   	$this->parameters["appid"] = WxPayConf_pub::APPID;//公众账号ID
		   	$this->parameters["mch_id"] = WxPayConf_pub::MCHID;//商户号
			$this->parameters["sub_appid"] = WxPayConf_pub::SUB_APPID;//公众账号ID
			$this->parameters["sub_mch_id"] = WxPayConf_pub::SUB_MCHID;//商户号
	...
	{
		$this->postXml();
		$this->result = $this->xmlToArray($this->response);var_dump($this->result);exit;
