...
?><!DOCTYPE html><html lang="en">
	...
	<body>
	    ...
	    <div class="container">
			<div class="row">
				<div class="col-md-6 chart" id="chart1"></div>
				<div class="col-md-6 chart" id="chart2"></div>
				<div class="col-md-6 chart" id="chart3"></div>
				<div class="col-md-6 chart" id="chart4"></div>
				<div class="col-md-6 chart" id="chart5"></div>
			</div>			
		</div>			

	</body>
	<?php
    include_once 'public/views/h_header_chart.php';
    ?>
    <script>
        ...
        title: {
            text: 'USD to EUR exchange rate from 2006'
        },
        subtitle: {
