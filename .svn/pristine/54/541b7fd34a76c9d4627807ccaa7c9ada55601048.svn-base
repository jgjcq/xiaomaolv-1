...
var showDialogModal = function(url,width,height,func) {
	...
	// 	//获取title
	// 		if(diag.innerFrame.contentWindow.document.getElementById('modal_title')){
	// 			$('#_Title_'+diag.ID,top.window.document).html(diag.innerFrame.contentWindow.document.getElementById('modal_title').value);
	// 		}
...
// 添加按钮
var addDialogButton=function(name, callback){
