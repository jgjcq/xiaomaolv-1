...
class WxPayConf_pub
{
    ...
    const JS_API_CALL_URL = 'http://zjyuxinjiaoyu.com/wx/demo/js_api_call.php';
    ...
    const NOTIFY_URL = 'http://zjyuxinjiaoyu.com/wx/demo/notify_url.php';
