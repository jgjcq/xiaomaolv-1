...
<link rel="stylesheet" href="cust/js/select2/css/select2.css" />
<![endif]-->
...
<script src="cust/js/select2/js/select2.js"></script>
<script src="cust/js/select2/js/i18n/zh-CN.js"></script>
<!-- ace scripts -->
