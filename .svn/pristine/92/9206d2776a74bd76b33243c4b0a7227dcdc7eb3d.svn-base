...
(function ($) {
    ...
    $.fn.uploadFile = function (options) {
        ...
        var s = $.extend({
            ...
            deleteStr: "Delete",
            doneStr: "Done",
            multiDragErrorStr: "多个文件拖拽,下降是不允许的.",
            extErrorStr: "不允许被上传，被允许上传的文件格式只能为: ",
            duplicateErrorStr: "不允许被上传. 文件已经存在.",
            sizeErrorStr: "不允许被上传. 文件大小超过允许的最大尺寸: ",
            uploadErrorStr: "不允许上传",
            maxFileCountErrorStr: " 不允许被上传，最大上传数量为:",
