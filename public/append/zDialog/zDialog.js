 ...
 * 最后修正：2009-12-18
 **/
var IMAGESPATH = 'public/append/zDialog/images/'; //图片路径配置
        ...
        return "";
          ...
          <tr id="_ButtonRow_' + this.ID + '" style="' + (this.ShowButtonRow ? "" : "display:none") + '">\
            <td height="36"><div id="_DialogButtons_' + this.ID + '" style="border-top: 1px solid #DADEE5; padding: 8px 20px; text-align: right; background-color:#f6f6f6;">\
                <input style="display:none;" type="button" class="buttonStyle" value="确 定" id="_ButtonOK_' + this.ID + '"/>\
                <input type="button" class="buttonStyle" value="取 消" onclick="Dialog.getInstance(\'' + this.ID + '\').close();" id="_ButtonCancel_' + this.ID + '" style="border:none; background-color:#D15B47; color:white; height:30px; width:60px; border-radius:3px;"/>\
              </div></td>\
          </tr>\
        </table></td>\
...
Dialog.prototype.show = function () {
    $('body',top.window.document).css('overflow','hidden');
    this.create();
...
Dialog.prototype.close = function () {
    $('body',top.window.document).css('overflow','auto');
...
Dialog.prototype.addButton = function (id, txt, func) {
    ...
    button.type = "button";
    button.style.cssText = "margin-right:5px; border:none; background-color:#438EB9; color:white; height:30px; width:60px; border-radius:3px;";
    button.value = txt;
    button.onclick = func;
